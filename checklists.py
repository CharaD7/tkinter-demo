...
numbers = ("One", "Five", "Eleven", "Twelve", "Sixteen"
           )  # This is the tuple variable to hold some strings
...
for number in numbers:
    lbListbox.insert(
        END, number)  # Insert every number at the end( on the next line)
...
cbCombobox = Combobox(win,
                      value=numbers)  # Setting the values for the combobox
