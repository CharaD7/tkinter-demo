...
def btnEqual():
    global expression  # Using global to expose the expression variable outside of the function
    result = str( eval( expression ) )  # eval to evaluate the expression in the string for calculation
...
txtFrame = Frame( win, width = 400, height = 48, bd = 0, highlightbackground = "black", highlightcolor = "black", highlightthickness = 1 )
...
btnEmpty = Button( btnsFrame, text = "C", fg = "black", width = 39, height = 3, bd = 0, bg = "#eee", cursor = "hand2", command = lambda: btnClear() )
btnEmpty.grid( row = 0, column = 0, columnspan = 3, padx = 1, pady = 1 )
...
btnZero = Button( btnsFrame, text = "0", fg = "black", width = 25, height = 3, bg = "#fff", cursor = "hand2", command = lambda: btnClick( 0 ) )
